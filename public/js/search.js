...
Search.prototype.onEvent = function () {
    let timeout;
...
Search.prototype.hide = function (elem) {
    elem.classList.add("hide");
}

Search.prototype.show = function (elem) {
    elem.classList.remove("hide");
}


Search.prototype.makeRankList = function () {
    const itemCount1 = 5;
    const itemCount2 = 10;
...
Search.prototype.activateSearch = function () {
...
Search.prototype.deActivateSearch = function () {
